  ...
  <div class="project-container col-3-lg">
    ...
    <div class="project-info">
      <div class="info-container" ref="info">
        ...
        <div class="pb-1">
          <slot name="description">Description of the App</slot>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    handleScroll() {
      ...
      if(elementBottom <= (window.innerHeight || document.documentElement.clientHeight) || elementTop <= window.innerHeight / 2) {
